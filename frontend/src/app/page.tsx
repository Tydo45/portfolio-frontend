  ...
  return (
    <section className="mx-auto max-w-5xl px-4 py-16">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <Link href="/projects" className="rounded-xl border bg-white p-6 shadow-sm hover:shadow">
          <h2 className="text-lg font-semibold">Projects</h2>
          <p className="mt-1 text-sm text-gray-600">Trading platform, AP invoice tooling, more.</p>
        </Link>
        <Link href="/about" className="rounded-xl border bg-white p-6 shadow-sm hover:shadow">
